...
public class ReservationSlotService {
    ...
    public List<ReservationSlotResponse> findAvailableSlots(LocalDate date) {
        return List.of(
            buildSlot(date, "10:30", "recommended", "原口"),
            buildSlot(date, "13:00", "open", "清水"),
            buildSlot(date, "15:30", "open", "大塚")
        );
    }

    private ReservationSlotResponse buildSlot(LocalDate date, String time, String status, String instructorName) {
